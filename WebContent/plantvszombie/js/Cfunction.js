...
oP = {
  ...
  MB1: function(e, j, m, f) {
    var d = e.id,
      ...
      l = e.ChangeC,
      b = oZ["getZ" + a](q, g);
    n < 1 && f[g + "_" + c] && l != c && ((e.Kind = ++n) && (h = e.Attack = 40), e.ChangeC = c, k.src = "plantvszombie/images/Plants/PB" + n + a + ".gif");
    b && b.Altitude == 1 ? (b.getHurt(-1, a, h, n, 0, 0, 0), m.splice(j, 1), (SetStyle(k, {
      left: e.pixelLeft + 28 + "px"
    })).src = "plantvszombie/images/Plants/PeaBulletHit.gif", oSym.addTask(10, ClearChild, [k])) : (e.X += (p = !a ? 5 : -5)) < oS.W && e.X > 100 ? k.style.left = (e.pixelLeft += p) + "px" : (m.splice(j, 1), ClearChild(k))
  },
  MB2: function(d, g, h) {
    var c = d.id,
      j = d.X,
    ...
    })).src = "plantvszombie/images/Plants/ShroomBulletHit.gif", oSym.addTask(10, ClearChild, [e])) : (d.X += 5) < oS.W ? e.style.left = (d.pixelLeft += 5) + "px" : (h.splice(g, 1), ClearChild(e))
  },
  MB3: function(g, d, a) {
    var h = g.id,
      b = $(h),
...
$SSml = function(d, c, a) {
  ...
  var f = screen.width,
    d = '<object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=10,0,0,0" width="330" height="250" id="adCenter" align="middle"><param name="allowScriptAccess" value="always"/><param name="allowFullScreen" value="false" /><param name="movie" value="plantvszombie/images/link/flash.swf?pubid=ca-games-pub-8771551875705681&channels=2041779255&contentid=%ef%bf%bd%ef%bf%bd%ef%bf%bd%d0%b4&adType=graphical_fullscreen&adWidth=330&adHeight=250&descriptionUrl=http%3a%2f%2fwww.5654.com" /><param name="quality" value="high" /><param name="bgcolor" value="#ffffff" /><embed width="330" height="250" src="plantvszombie/images/link/flash.swf?pubid=ca-games-pub-8771551875705681&channels=2041779255&contentid=%ef%bf%bd%ef%bf%bd%ef%bf%bd%d0%b4&adType=graphical_fullscreen&adWidth=330&adHeight=250&descriptionUrl=http%3a%2f%2fwww.5654.com" quality="high" pluginspage="http://www.adobe.com/go/getflashplayer_cn" align="middle" play="true" loop="true" scale="showall" wmode="window" devicefont="false" bgcolor="#ffffff" name="ad" menu="true" allowfullscreen="false" allowscriptaccess="always" salign="" type="application/x-shockwave-flash"></object>',
  ...
  oS.CenterContent = d;
  document.write('<div id="dLink"><div><a href="http://www.xiazai.com/" target="_blank" style="color:#FF0;font-weight:bold"><img src="plantvszombie/images/link/a5logo.png" border="0" title="非常感谢a5下载网站友情赞助的空间" height="59"></a></div><div><a href="http://www.xiaody.com" target="_blank"><img height="59" src="http://www.xiaody.com/logo.gif" alt="小电影" border="0"></a></div>');
  ...
  $("oEmbed").innerHTML = '<object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=10,0,0,0" width="0" height="0" align="middle"><param name="allowScriptAccess" value="always"/><param name="allowFullScreen" value="false" /><param name="movie" value="plantvszombie/music/' + a + '" /><param name="quality" value="high" /><param name="bgcolor" value="#ffffff" /><embed width="0" height="0" src="plantvszombie/music/' + a + '" quality="high" pluginspage="http://www.adobe.com/go/getflashplayer_cn" align="middle" play="true" loop="true" scale="showall" wmode="window" devicefont="false" bgcolor="#ffffff" name="ad" menu="true" allowfullscreen="false" allowscriptaccess="always" salign="" type="application/x-shockwave-flash"></object>'
}, ClearMusic = function() {
  $("oEmbed").innerHTML = ""
};
