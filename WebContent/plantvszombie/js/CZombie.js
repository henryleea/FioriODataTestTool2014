var CZombies = function(b, a) {
    return (a = function() {}).prototype = {
      ...
      getFreeze: function(d, c) {
        ...
        }, [c, d.FreeFreezeTime = oSym.Now + 400, NewImg("icetrap_" + Math.random(), "plantvszombie/images/Plants/IceShroom/icetrap.gif", d.getShadow(d), d.Ele)])
      },
      ChangeR: function(e) {
        var h = e.R,
          g = e.ar || [],
  ...
  oBackupDancer = InheritO(OrnNoneZombies, {
    ...
    OSpeed: 3.5,
    PicArr: (function() {
      var a = "plantvszombie/images/Zombies/BackupDancer/";
      return ["plantvszombie/images/Card/Zombies/BackupDancer.png", "plantvszombie/images/Card/Zombies/BackupDancerG.png", a + "BackupDancer.gif", a + "Attack.gif", a + "LostHead.gif", a + "LostHeadAttack.gif", a + "Head.gif" + $Random, a + "Die.gif" + $Random, a + "BoomDie.gif" + $Random, a + "Dancing.gif" + $Random, a + "LostHeadDancing.gif" + $Random, a + "Mound.gif" + $Random]
    })(),
    bedevil: function(a) {
      a.ExchangeLR(a, 1);
    ...
    getFreeze: function(b, a) {
      ...
      }, [a, b.FreeFreezeTime = oSym.Now + 400, NewImg("icetrap_" + Math.random(), "plantvszombie/images/Plants/IceShroom/icetrap.gif", b.getShadow(b), b.Ele)])
    },
  ...
  oDancingZombie = InheritO(OrnNoneZombies, {
    ...
    addSpotlight: (function() {
      ...
      return function(d, f, c) {
        var g = $Z[d],
          e;
        NewEle(d + "_spotlightCon", "div", "position:absolute;left:-30px;top:-400px;width:184px;height:600px;overflow:hidden", 0, c).appendChild(g.spotlight = NewImg(d + "_spotlight", "plantvszombie/images/Zombies/DancingZombie/spotlight" + a + ".png", "left:0;top:0;width:920px;height:600px;" + b));
    ...
    TurnLeft: function(c) {
      ...
      c.getFreeze = function(e, d) {
        ...
        }, [d, e.FreeFreezeTime = oSym.Now + 400, NewImg("icetrap_" + Math.random(), "plantvszombie/images/Plants/IceShroom/icetrap.gif", e.getShadow(e), e.Ele)])
      };
    ...
    Summon: function(d, c) {
      ...
      d.ChkActs = d.ChkTmp;
      d.ChkTmp = b;
      a.src = "plantvszombie/images/Zombies/DancingZombie/Summon1.gif";
      oSym.addTask(10, function(f, e) {
        var g = $Z[f];
        g && g.beAttacked && (e.src = "plantvszombie/images/Zombies/DancingZombie/Summon2.gif", oSym.addTask(10, function(t, s, x) {
          var h = $Z[t],
            v = h.ZX,
            m = h.ArDZ,
            n = [],
            k = "plantvszombie/images/Zombies/BackupDancer/Mound.gif" + $Random + Math.random(),
            r = 4,
            w = [],
            u = [],
            o = 0,
            q, l;
          if (h && h.beAttacked) {
            s.src = "plantvszombie/images/Zombies/DancingZombie/Summon3.gif";
            while (r--) {
  ...
  oZombie2 = InheritO(oZombie, {
    ...
    PicArr: {
      2: "plantvszombie/images/Zombies/Zombie/Zombie2.gif",
      9: "plantvszombie/images/Zombies/Zombie/2.gif"
    }
  }),
  oZombie3 = InheritO(oZombie, {
    ...
    PicArr: {
      2: "plantvszombie/images/Zombies/Zombie/Zombie3.gif",
      9: "plantvszombie/images/Zombies/Zombie/3.gif"
    }
  }),
  oFlagZombie = InheritO(oZombie, {
    PicArr: (function() {
      var a = "plantvszombie/images/Zombies/FlagZombie/";
      return ["plantvszombie/images/Card/Zombies/FlagZombie.png", "plantvszombie/images/Card/Zombies/FlagZombieG.png", a + "FlagZombie.gif", a + "FlagZombieAttack.gif", a + "FlagZombieLostHead.gif", a + "FlagZombieLostHeadAttack.gif", "plantvszombie/images/Zombies/Zombie/ZombieHead.gif" + $Random, "plantvszombie/images/Zombies/Zombie/ZombieDie.gif" + $Random, "plantvszombie/images/Zombies/Zombie/BoomDie.gif" + $Random, a + "1.gif"]
    })(),
    EName: "oFlagZombie",
    CName: "旗帜僵尸",
    OSpeed: 2.2,
  ...
  oConeheadZombie = InheritO(OrnIZombies, {
    ...
    StandGif: 11,
    PicArr: (function() {
      var b = "plantvszombie/images/Zombies/ConeheadZombie/",
        a = "plantvszombie/images/Zombies/Zombie/";
      return ["plantvszombie/images/Card/Zombies/ConeheadZombie.png", "plantvszombie/images/Card/Zombies/ConeheadZombieG.png", b + "ConeheadZombie.gif", b + "ConeheadZombieAttack.gif", a + "ZombieLostHead.gif", a + "ZombieLostHeadAttack.gif", a + "ZombieHead.gif" + $Random, a + "ZombieDie.gif" + $Random, a + "BoomDie.gif" + $Random, a + "Zombie.gif", a + "ZombieAttack.gif", b + "1.gif"]
    })(),
  ...
  oBucketheadZombie = InheritO(oConeheadZombie, {
    ...
    PicArr: {
      0: "plantvszombie/images/Card/Zombies/BucketheadZombie.png",
      1: "plantvszombie/images/Card/Zombies/BucketheadZombieG.png",
      2: "plantvszombie/images/Zombies/BucketheadZombie/BucketheadZombie.gif",
      3: "plantvszombie/images/Zombies/BucketheadZombie/BucketheadZombieAttack.gif",
      9: "plantvszombie/images/Zombies/Zombie/Zombie2.gif",
      11: "plantvszombie/images/Zombies/BucketheadZombie/1.gif"
    }
  }),
  oFootballZombie = InheritO(oConeheadZombie, {
    ...
    PicArr: (function() {
      var a = "plantvszombie/images/Zombies/FootballZombie/";
      return ["plantvszombie/images/Card/Zombies/FootballZombie.png", "plantvszombie/images/Card/Zombies/FootballZombieG.png", a + "FootballZombie.gif", a + "Attack.gif", a + "LostHead.gif", a + "LostHeadAttack.gif", "plantvszombie/images/Zombies/Zombie/ZombieHead.gif" + $Random, a + "Die.gif" + $Random, a + "BoomDie.gif" + $Random, a + "OrnLost.gif", a + "OrnLostAttack.gif", a + "1.gif"]
    })(),
    getShadow: function(a) {
  ...
  oPoleVaultingZombie = InheritO(OrnNoneZombies, {
    ...
    NormalAttack: function(d, b) {
      var g = $Z[d],
        ...
        c = g.EleShadow,
        e = g.EleBody;
      e.src = "plantvszombie/images/Zombies/PoleVaultingZombie/PoleVaultingZombieJump.gif" + $Random + Math.random();
      SetHidden(c);
      g.isAttacking = 1;
      g.Altitude = 2;
      ...
      oSym.addTask(100, function(m, j, i, l, n) {
        ...
        h && ((k = $P[j]) && k.Stature > 0 ? (h.AttackedRX = (h.X = (h.AttackedLX = h.ZX = q = k.AttackedRX) - h.beAttackedPointL) + h.beAttackedPointR, SetStyle(i, {
          left: h.X + "px"
        }), n.src = "plantvszombie/images/Zombies/PoleVaultingZombie/PoleVaultingZombieWalk.gif", SetVisible(l), h.isAttacking = 0, h.Altitude = 1, h.OSpeed = h.Speed = 1.6, h.NormalGif = 9, h.LostHeadGif = 10, h.NormalAttack = (r = CZombies.prototype).NormalAttack, h.getFreeze = r.getFreeze, h.getRaven = r.getRaven) : (h.ZX = h.AttackedLX = (h.X = (h.AttackedRX = f) - h.beAttackedPointR) + h.beAttackedPointL, SetStyle(i, {
          left: h.X + "px"
        }), n.src = "plantvszombie/images/Zombies/PoleVaultingZombie/PoleVaultingZombieJump2.gif" + $Random + Math.random(), SetVisible(l), oSym.addTask(80, function(s, v) {
          var u = $Z[s],
            t;
          u && (v.src = "plantvszombie/images/Zombies/PoleVaultingZombie/PoleVaultingZombieWalk.gif", u.isAttacking = 0, u.Altitude = 1, u.OSpeed = u.Speed = 1.6, u.NormalGif = 9, u.LostHeadGif = 10, u.NormalAttack = (t = CZombies.prototype).NormalAttack, u.getFreeze = t.getFreeze, u.getRaven = t.getRaven)
        }, [m, n])))
      }, [d, b, a, c, e])
    }
  }),
  ...
  oNewspaperZombie = InheritO(OrnIIZombies, {
    ...
    LostPaperSpeed: 4.8,
    PicArr: (function() {
      var a = "plantvszombie/images/Zombies/NewspaperZombie/";
      return ["plantvszombie/images/Card/Zombies/NewspaperZombie.png", "plantvszombie/images/Card/Zombies/NewspaperZombieG.png", a + "HeadWalk1.gif", a + "HeadAttack1.gif", a + "LostHeadWalk1.gif", a + "LostHeadAttack1.gif", a + "HeadWalk0.gif", a + "HeadAttack0.gif", a + "LostHeadWalk0.gif", a + "LostHeadAttack0.gif", a + "Head.gif" + $Random, a + "Die.gif" + $Random, a + "BoomDie.gif" + $Random, a + "LostNewspaper.gif", a + "1.gif"]
    })(),
    ...
    BirthCallBack: function(g) {
      ...
      switch (true) {
        ...
        default:
          ...
          SetHidden(f);
          NewEle(a = c + "_splash", "div", "position:absolute;background:url(plantvszombie/images/interface/splash.png);left:61px;top:62px;width:97px;height:88px;over-flow:hidden", 0, b);
          ImgSpriter(a, c, [
            ["0 0", 9, 1],
            ["-97px 0", 9, 2],
            ["-194px 0", 9, 3],
  ...
  oDuckyTubeZombie1 = InheritO(oAquaticZombie, {
    ...
    PicArr: (function() {
      var a = "plantvszombie/images/Zombies/DuckyTubeZombie1/";
      return ["plantvszombie/images/Card/Zombies/DuckyTubeZombie1.png", "plantvszombie/images/Card/Zombies/DuckyTubeZombie1G.png", a + "Walk1.gif", a + "Walk2.gif", a + "1.gif", a + "Attack.gif", "plantvszombie/images/Zombies/Zombie/ZombieHead.gif" + $Random, a + "Die.gif" + $Random]
    })(),
    GoingDie: function() {
      var b = this,
        c = b.id,
  ...
  oDuckyTubeZombie2 = InheritO(oDuckyTubeZombie1, {
    ...
    SunNum: 75,
    PicArr: (function() {
      var b = "plantvszombie/images/Zombies/DuckyTubeZombie2/",
        a = "plantvszombie/images/Zombies/DuckyTubeZombie1/";
      return ["plantvszombie/images/Card/Zombies/DuckyTubeZombie1.png", "plantvszombie/images/Card/Zombies/DuckyTubeZombie1G.png", b + "Walk1.gif", b + "Walk2.gif", b + "1.gif", b + "Attack.gif", "plantvszombie/images/Zombies/Zombie/ZombieHead.gif" + $Random, a + "Die.gif" + $Random, a + "Walk1.gif", a + "Walk2.gif", a + "Attack.gif"]
    })(),
    getHurt: function(i, a, g, m, c, k, j) {
      var e = this;
      if (!e.beAttacked) {
  ...
  oDuckyTubeZombie3 = InheritO(oDuckyTubeZombie2, {
    ...
    SunNum: 125,
    PicArr: (function() {
      var b = "plantvszombie/images/Zombies/DuckyTubeZombie3/",
        a = "plantvszombie/images/Zombies/DuckyTubeZombie1/";
      return ["plantvszombie/images/Card/Zombies/DuckyTubeZombie1.png", "plantvszombie/images/Card/Zombies/DuckyTubeZombie1G.png", b + "Walk1.gif", b + "Walk2.gif", b + "1.gif", b + "Attack.gif", "plantvszombie/images/Zombies/Zombie/ZombieHead.gif" + $Random, a + "Die.gif" + $Random, a + "Walk1.gif", a + "Walk2.gif", a + "Attack.gif"]
    })()
  }),
  oSnorkelZombie = InheritO(oDuckyTubeZombie1, {
    ...
    PicArr: (function() {
      var a = "plantvszombie/images/Zombies/SnorkelZombie/";
      return ["plantvszombie/images/Card/Zombies/SnorkelZombie.png", "plantvszombie/images/Card/Zombies/SnorkelZombieG.png", a + "Walk1.gif", a + "Walk2.gif", a + "1.gif", a + "Attack.gif", a + "Head.gif" + $Random, a + "Die.gif" + $Random, a + "Jump.gif" + $Random, a + "Risk.gif" + $Random, a + "Sink.gif" + $Random]
    }()),
